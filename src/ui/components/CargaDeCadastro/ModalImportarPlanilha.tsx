...
const COLUNAS_CONTRATOS: readonly ColunaExemplo[] = [
  ...
  { nome: 'data_inicio', obrigatorio: true, aceita: 'AAAA-MM-DD', exemplo: '2023-03-15' },
  { nome: 'data_fim', obrigatorio: false, aceita: 'AAAA-MM-DD (vazio = sem prazo definido)', exemplo: '2026-12-31' },
